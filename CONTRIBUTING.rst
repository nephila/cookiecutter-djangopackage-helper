...
Report bugs at https://github.com/nephila/cookiecutter-djangopackage-helper/issues
...
`cookiecutter-djangopackage-helper`_ could always use more documentation, whether as part of the
official docs, in docstrings, or even on the web in blog posts, articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/nephila/cookiecutter-djangopackage-helper/issues.
...
Ready to contribute? Here's how to set up `cookiecutter-djangopackage-helper`_ for local development. Please note this documentation assumes you have a `GitHub`_ account,
...
1. Fork the `cookiecutter-djangopackage-helper`_ repo on GitHub.
...
5. The next step would be to run the test cases. `cookiecutter-djangopackage-helper`_ uses py.test, you can run PyTest. Before you run pytest you should ensure all dependancies are installed::
